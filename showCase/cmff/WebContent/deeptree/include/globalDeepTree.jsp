<%@page contentType="text/html;charset=UTF-8" language="java"%><%
	...
	if(nodeRelationType == null || nodeRelationType.length() == 0 || (!"hasRelation".equals(nodeRelationType) && !"noRelation".equals(nodeRelationType) && !"mutualRelation".equals(nodeRelationType))) {
...
%>
<script type="text/javascript" src="<%=request.getContextPath()%>/deeptree/js/jquery/jquery.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/deeptree/js/jquery/jquery.transform.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/deeptree/js/deeptree.js"></script>
<script type="text/javascript">
	...
	var xslPath = "<%=request.getContextPath()%>/deeptree/deeptree_xsl.jsp?inputType=" + inputType + "&treeImagePath=" + treeImagePath ;  //xslt文件相对路径
...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/deeptree/css/gridtree.css"/>