	...
	<xsl:template match="TreeNode">
		<xsl:for-each select=".">
			...
			<div class="TreeNode" nowrap="true" name="deeptree_div">
				...
				<% } %>
				<xsl:attribute name="isOptional"><xsl:value-of select="@isOptional"/></xsl:attribute>
				<!--新添加的属性结束-->
				...
				<xsl:otherwise>				
				<input type="checkbox" name="<%=winId%>deeptree_checkbox" style="margin:top" class="tree-firerift-style-checkbox-o">
